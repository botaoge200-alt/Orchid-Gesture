...
HOST = '127.0.0.1'
PORT = 9876
MODEL_NAME = "Generated_Shirt_Collar"
PROMPT = "A high quality 3D model of a formal long-sleeved shirt with a collar, button-down, realistic fabric texture, isolated white background"
