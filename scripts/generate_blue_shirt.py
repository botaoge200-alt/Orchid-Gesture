...
PROMPT = "A high quality 3D model of a blue long-sleeved outdoor shirt, single chest pocket, collar, button-down, tactical style, realistic fabric texture, isolated white background"
